  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Produk</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Kelola katalog Anda, edit detail, dan atur informasi produk untuk AI.</p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline" className="border-dashed border-slate-300 dark:border-slate-700">
      ...
      <Card className="border-none shadow-md shadow-slate-200/40 dark:shadow-none bg-white dark:bg-slate-900">
        ...
        <CardContent>
          {/* Empty State */}
          <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-900/50">
