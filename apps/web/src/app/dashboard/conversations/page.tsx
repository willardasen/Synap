...
export default function ConversationsPage() {
  return (
    <div className="h-[calc(100vh-2rem)] flex flex-col space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 flex-shrink-0">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Percakapan</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Tinjau interaksi otomatis WhatsApp antara AI dan pelanggan secara real-time.</p>
        </div>
      </div>
